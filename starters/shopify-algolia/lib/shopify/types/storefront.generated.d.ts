...
export type SingleCollectionFragment = (
  ...
  & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText' | 'width' | 'height'>>, pageDisplayTypeMetafield?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'value' | 'type' | 'id'>>, seo: Pick<StorefrontTypes.Seo, 'description' | 'title'> }
);
