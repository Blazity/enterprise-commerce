...
// Manually selected category handles for homepage
...
export async function EnterpriseCategoriesSection() {
  // Fetch individual categories from Algolia using rate-limited function
  ...
  return (
    <section className="relative w-full py-24">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        {/* 2x2 Grid with negative margins for overflow effect */}
