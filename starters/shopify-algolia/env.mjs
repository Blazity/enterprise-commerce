...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    SHOPIFY_STOREFRONT_ACCESS_TOKEN:
      process.env.SHOPIFY_STOREFRONT_ACCESS_TOKEN || "demo",
    SHOPIFY_ADMIN_ACCESS_TOKEN:
      process.env.SHOPIFY_ADMIN_ACCESS_TOKEN || "demo",
    SHOPIFY_APP_API_SECRET_KEY:
      process.env.SHOPIFY_APP_API_SECRET_KEY || "demo",
    SHOPIFY_STORE_DOMAIN: process.env.SHOPIFY_STORE_DOMAIN || "demo",
    SHOPIFY_HIERARCHICAL_NAV_HANDLE:
      process.env.SHOPIFY_HIERARCHICAL_NAV_HANDLE,
    ALGOLIA_PRODUCTS_INDEX: process.env.ALGOLIA_PRODUCTS_INDEX || "products",
    ALGOLIA_CATEGORIES_INDEX:
      process.env.ALGOLIA_CATEGORIES_INDEX || "categories",
    ...
    IS_VERCEL_ANALYTICS_ENABLED:
      process.env.IS_VERCEL_ANALYTICS_ENABLED || "true",
