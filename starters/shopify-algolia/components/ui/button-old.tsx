...
const buttonVariants = cva("inline-flex border border-gray-300 rounded-md text-center overflow-hidden group relative disabled:opacity-70 disabled:cursor-not-allowed", {
  variants: {
    variant: {
