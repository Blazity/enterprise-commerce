...
interface UniformProductCardProps extends Pick<CommerceProduct, "variants" | "handle" | "images" | "title" | "featuredImage" | "minPrice" | "avgRating" | "totalReviews" | "vendor"> {
  priority?: boolean
  prefetch?: boolean
  className?: string
  featured?: boolean
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col p-4">
        <h3 className={cn(
          "mb-1 line-clamp-2 font-semibold",
        ...
        {vendor && (
          <p className="mb-2 text-sm text-muted-foreground line-clamp-1">{vendor}</p>
        )}
