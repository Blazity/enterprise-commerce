...
export const ReviewsSection = async ({ productId, productHandle, summary, avgRating, className, slug }: ReviewsSectionProps) => {
  ...
  if (reviews?.length <= 0) {
    return (
      <section className={cn("relative left-1/2 w-full -translate-x-1/2 rounded-lg bg-gray-50 py-12 md:my-10 xl:w-screen", className)}>
  ...
  return (
    <section className={cn("relative left-1/2 w-full -translate-x-1/2 bg-gray-50 py-12 md:my-10 xl:w-screen", className)}>
