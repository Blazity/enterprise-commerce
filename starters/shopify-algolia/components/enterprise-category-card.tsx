...
export const EnterpriseCategoryCard = ({ 
  category, 
  priority = false,
  className 
}: EnterpriseCategoryCardProps) => {
      ...
      <div className="relative size-full overflow-hidden bg-secondary/5">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-12 text-white">
          ...
          {category.description && (
            <p className="mb-4 text-base opacity-90 line-clamp-2 transition-opacity duration-300 group-hover:opacity-100">
              {category.description}
            </p>
          )}
