...
export default async function Product({ params: { slug } }: ProductProps) {
  ...
  return (
    <div className="relative mx-auto max-w-container-md px-4 xl:px-0">
      ...
      <div className="mb:pb-8 relative w-full py-4 md:pt-12 flex items-center justify-center gap-10">
        <BackButton className="mb-8 hidden md:block xl:absolute left-2" />
        <div className="max-w-container-sm w-full mx-auto">
