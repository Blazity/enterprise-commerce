...
<Frame>
  <img className="block" src="/images/cli-demo.gif" alt="Cli demo" />
</Frame>
...
- **Application Setup and Scopes Configuration:**
  ...
  6. Lastly, navigate to the `API Credentials` section.
     ...
     - Also, copy the `SHOPIFY_APP_API_KEY` and place it in your `.env.local` file under `SHOPIFY_APP_API_KEY`
