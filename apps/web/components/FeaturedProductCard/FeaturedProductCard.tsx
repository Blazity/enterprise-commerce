...
export const FeaturedProductCard = ({
  ...
  return (
    <Link
      className={cn("group flex flex-col overflow-hidden rounded-lg border border-gray-100 shadow-md transition-all", className)}
      aria-label={linkAria}
      href={href}
      prefetch={prefetch}
    >
      ...
      <div className="flex shrink-0 grow flex-col gap-2 p-4 transition-colors group-hover:bg-gradient-to-t group-hover:from-gray-100 group-hover:to-transparent">
