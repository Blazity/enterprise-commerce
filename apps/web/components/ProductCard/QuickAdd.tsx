...
export function QuickAdd({ variants }: QuickAddProps) {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-50 hidden h-0 overflow-hidden bg-white transition-all group-hover:h-[90px] group-hover:border-t group-hover:border-black lg:block">
      <div className="p-2">
