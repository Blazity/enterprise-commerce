...
export const CompactProductCard = ({
  ...
  return (
    <Link
      className={cn("group relative flex flex-col overflow-hidden rounded-lg border border-gray-100 shadow-md transition-all", className)}
      aria-label={linkAria}
      href={href}
      prefetch={prefetch}
    >
      ...
      <div className="absolute bottom-0 flex w-full shrink-0 grow translate-y-full flex-col gap-2 overflow-hidden bg-gradient-to-t from-gray-100 to-transparent p-4 transition-transform group-hover:translate-y-0">
