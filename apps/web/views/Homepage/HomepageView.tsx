 ...
 * @see https://v0.dev/t/1bcNI4EgKgp
 */
  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      <main className="container mx-auto flex-1">
        <section className="w-full py-6 sm:py-12 md:py-24 xl:py-32">
      ...
      <footer className="container mx-auto flex w-full shrink-0 flex-col items-center gap-2 border-t px-4 py-6 sm:flex-row md:px-6">
