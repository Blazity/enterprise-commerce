...
export type SingleAdminProductQuery = { product?: AdminTypes.Maybe<(
    ...
    & { options: Array<Pick<AdminTypes.ProductOption, 'id' | 'name' | 'values'>>, collections: { nodes: Array<Pick<AdminTypes.Collection, 'handle' | 'title' | 'description' | 'updatedAt'>> }, priceRange: { maxVariantPrice: Pick<AdminTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<AdminTypes.MoneyV2, 'amount' | 'currencyCode'> }, variants: { edges: Array<{ node: (
