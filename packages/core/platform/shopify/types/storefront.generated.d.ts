      ...
      node:
        | (Pick<StorefrontTypes.CartLine, "id" | "quantity"> & {
            ...
            merchandise: Pick<StorefrontTypes.ProductVariant, "id" | "title"> & {
              ...
              product: Pick<StorefrontTypes.Product, "id" | "handle" | "title" | "description" | "descriptionHtml" | "tags" | "updatedAt" | "createdAt"> & {
...
export type SingleProductFragment = Pick<StorefrontTypes.Product, "id" | "handle" | "title" | "description" | "descriptionHtml" | "tags" | "updatedAt" | "createdAt"> & {
  options: Array<Pick<StorefrontTypes.ProductOption, "id" | "name" | "values">>
  priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, "amount" | "currencyCode">; minVariantPrice: Pick<StorefrontTypes.MoneyV2, "amount" | "currencyCode"> }
  variants: {
    edges: Array<{
...
export type CollectionProductsQuery = {
  collection?: StorefrontTypes.Maybe<{
    products: {
      edges: Array<{
        node: Pick<StorefrontTypes.Product, "id" | "handle" | "title" | "description" | "descriptionHtml" | "tags" | "updatedAt" | "createdAt"> & {
          options: Array<Pick<StorefrontTypes.ProductOption, "id" | "name" | "values">>
          priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, "amount" | "currencyCode">; minVariantPrice: Pick<StorefrontTypes.MoneyV2, "amount" | "currencyCode"> }
          variants: {
            edges: Array<{
...
export type SingleProductQuery = {
  product?: StorefrontTypes.Maybe<
    Pick<StorefrontTypes.Product, "id" | "handle" | "title" | "description" | "descriptionHtml" | "tags" | "updatedAt" | "createdAt"> & {
