import { type DocumentOptions, type DocumentsDeletionQuery, type DocumentsIds, type DocumentsQuery, MeiliSearch, type SearchParams } from "meilisearch"
...
export const meilisearch = ({ host, adminApiKey }: MeilisearchArgsType) => {
