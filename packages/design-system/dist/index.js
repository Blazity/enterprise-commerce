...
function Button(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", __spreadProps(__spreadValues({ className: (0, import_tailwind_merge.twMerge)(button({ intent, size, className, underline })) }, props), { children: props.children }));
}
